...
def get_memory_service():
    """Process-wide memory service: VertexAiMemoryBankService when set/deployed, else option URI."""
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or "6705008823154769920"
    from google.adk.memory.vertex_ai_memory_bank_service import VertexAiMemoryBankService

    return VertexAiMemoryBankService(
        project="qwiklabs-gcp-01-d53bf4a69b0c",
        location="us-east1",
        agent_engine_id=agent_engine_id,
    )
